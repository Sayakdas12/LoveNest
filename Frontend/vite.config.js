  ...
  return {
    ...
    configureServer(server) {
      server.printUrls = () => {
        ...
        console.log(row('📜', 'Lenis',      'Inertia smooth momentum scroll active', GOLD))
        console.log(row('🤖', 'Groq LLM',   'AI Match compatibility assistant ready', TEAL))
        console.log(row('💳', 'Razorpay',   'VIP Membership payments ready', GOLD))
        console.log(row('📡', 'Socket.IO',  'Real-time chat & notifications active', LIME))
        console.log(row('🌌', 'p5.js',      'Interactive ForceField canvas ready', SKY))
